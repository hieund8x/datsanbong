...
<div id="datsan-wrapper">
    <form id="dat-san" action="" method="post">
        ...
        <div id="step-time" style="display: none;">
            <div class="step-content">
                <a class="btn-box" href="javascript:void(0)" value="1" loaisan="Sân cỏ" onclick="chonGio($(this))">12h30 - 14h00</a>
                <a class="btn-box" href="javascript:void(0)" value="1" loaisan="Sân cỏ" onclick="chonGio($(this))">14h00 - 15h30</a>
            </div>
            <div class="action">
